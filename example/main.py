import scripts.gen_csv_from_xml as gen_csv_from_xml
import scripts.gen_piechart_from_csv as gen_piechart_from_csv
import os
...
e_counts = gen_csv_from_xml.parse_checkstyle_report(input_xml_file, "", True)
gen_csv_from_xml.write_error_counts_to_csv(e_counts, csv_rule_file, 'Rule')
# generate three csv files with different level of severity
errors_counts = gen_csv_from_xml.parse_checkstyle_report(input_xml_file, "error")
warning_counts = gen_csv_from_xml.parse_checkstyle_report(input_xml_file, "warning")
info_counts = gen_csv_from_xml.parse_checkstyle_report(input_xml_file, "info")
gen_csv_from_xml.write_error_counts_to_csv(errors_counts, csv_error_file, 'Error')
gen_csv_from_xml.write_error_counts_to_csv(warning_counts, csv_warning_file, 'Warning')
gen_csv_from_xml.write_error_counts_to_csv(info_counts, csv_info_file, 'Info')
